...
public class Student_Login extends JFrame implements ActionListener
{
    ...
    public static void Insert(String s1,String s2,String s3,String s4,double s5,String s6,String s7,String s8,double s9,String s10,String s11,String s12,String s13)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {          
            ...
            JOptionPane.showMessageDialog(this, "Data Insertion Is Successful!","Message",JOptionPane.PLAIN_MESSAGE);
        }
        ...
        else if(string.equals("Row Count"))
        {
            ...
            int c = RowCount();
            JOptionPane.showMessageDialog(this, "Total Number of Rows : "+String.valueOf(c),"Message",JOptionPane.PLAIN_MESSAGE);
            this.count = 0;
        }
